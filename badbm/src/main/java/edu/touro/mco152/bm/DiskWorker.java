...
public class DiskWorker {
    ...
    public boolean start() throws Exception {
        /*
          ...
          its (super class's) execute2() method, causing Swing to eventually
          call this doInBackground2() method.
         */
        ...
        if (App.writeTest) {
             ...
             */
            for (int m = startFileNum; m < startFileNum + App.numOfMarks && !ui.isAborted(); m++) {
